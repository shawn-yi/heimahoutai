...
export default {
  ...
  computed: {
    name () {
      return this.tmpName || JSON.parse(window.sessionStorage.getItem('token')).name
    },
    photo () {
      return this.tmpPhoto || JSON.parse(window.sessionStorage.getItem('token')).photo
    }
  },
  methods: {
    logout () {
